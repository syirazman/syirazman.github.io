              ...
              <div class="card-body">
                  <form class="row g-3 needs-validation" method="post" id="add_student">
                    ...
                    <div>
                      ...
                      <input type="text" class="form-control" id="std_umur" name="std_umur" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input type="text" class="form-control" id="std_tarikh_lahir" name="std_tarikh_lahir" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input type="radio" class="std_jantina" name="std_jantina" value="lelaki">
                      <label for="lelaki">Lelaki</label>
                      <input type="radio" class="std_jantina" name="std_jantina" value="perempuan">
                    ...
                    <div>
                      ...
                      <input type="text" class="form-control" id="mykid" name="mykid" required>
                      <div class="invalid-feedback">
                    ...
                    <div>
                      ...
                      <input type="radio" class="std_kewarganegaraan" name="std_kewarganegaraan" value="warganegara">
                      <label for="warganegara">Warganegara</label>
                      <input type="radio" class="std_kewarganegaraan" name="std_kewarganegaraan" value="Bukan warganegaraan">
                    ...
                    <div>
                      ...
                      <input type="text" class="form-control" id="std_poskod" name="std_poskod" required>
                      <div class="invalid-feedback">
                  ...
                  <br>
                    ...
                    <div>
                      ...
                      <input type="text" class="form-control" id="no_ic" name="no_ic" placeholder="cth:XXXXXX-XX-XXXX" required>
                      <div class="valid-feedback">
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input type="text" class="form-control" id="no_telefon" name="no_telefon" placeholder="cth:XXX-XXXXXXXX" required>
                      <div class="valid-feedback">
                      </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              <h5>PENDAFTARAN ANDA MASIH DALAM PROSES</h5>
              <h5>SILA BAYAR YURAN PENDAFTARAN MURID PADA AKAUN:</h5>
