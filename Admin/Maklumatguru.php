                        ...
                        <form class="row g-3 needs-validation" id="updatedata" action="action_query/add_staff.php" method="POST">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group has-validation">
                                  <input type="text" class="form-control" id="data_tel" aria-describedby="inputGroupPrepend" name="notelefon" required>
                                  <div class="invalid-feedback">
                            ...
                            <form action="action_query/update_staff.php" method="POST">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                    <label for="validationCustomUsername" class="form-label">No Telefon</label>
                                    <div class="input-group has-validation">
                                      <input type="text" class="form-control" id="edit_tel" aria-describedby="inputGroupPrepend" name="notelefon" required>
                                      <div class="invalid-feedback">
                                        Sila lengkapkan No Telefon anda.
                                      </div>
                                    </div>
