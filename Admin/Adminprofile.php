    ...
    <body id="body-pd"> 
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                    ...
                    <div class="nav__list">
                        ...
                        <div class="dropdown-container">
                            <a href="Laporankehadiran.php" class="nav__link">
                                <i class="fas fa-clipboard-list"></i>
                                <span class="nav__name">Laporan Kehadiran Guru</span>
                            </a>
                            <a href="kehadiran_murid.php" class="nav__link">
                                <i class="fas fa-clipboard-list"></i>
                                <span class="nav__name">Laporan Kehadiran Murid</span>
                            </a>
                        </div>
                ...
                <a href="<?php echo 'http://'.$_SERVER['SERVER_NAME'] ?>/logout.php" class="nav__link">
        ...
        <div class="card">
            <div class="card-body">
                <form class="row g-3 needs-validation" id="updatedata" action="action_query/update_profile.php">
                    ...
                    <div class="col-md-6">
                        <label for="validationCustomUsername" class="form-label">No Telefon</label>
                        <div class="input-group has-validation">
                          <input type="text" value="<?php echo $val['phone']; ?>" class="form-control" id="data_tel" aria-describedby="inputGroupPrepend" name="notelefon" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="data_jawatan" name="jawatan" required>
                          ...
                          <option value="Parents" <?php ($val['jawatan'] == 'Parents') ? "selected" : '' ?>>Parents</option>
                        </select>
                        <div class="invalid-feedback">
