      ...
      <div class="card-body">
              <form id="updatedata">
                  ...
                  <input type="hidden" class="form-control" id="data_id" name="id" value="<?php echo $_SESSION['id'] ?>">
                    <div class="form-row">
                      <label>Name</label>
                      <input type="text" name="name" id="data_nama" class="form-control" placeholder="Name" value="<?php echo $val['name'] ?>">
                    </div>
                  <br>
                  <div class="form-row">
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                          <input type="text" name="email" id="data_email" class="form-control"  placeholder="Email" value="<?php echo $val['email'] ?>" aria-describedby="inputGroupPrepend">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <label>Nombor Telefon</label>
                        <div class="input-group">
                          <input type="text" name="phone" id="data_tel" class="form-control" placeholder="Phone" value="<?php echo $val['phone'] ?>" aria-describedby="inputGroupPrepend">
                        </div>
                      </div>
                  </div>
                  <br>
                  <div class="form-row">
                      <label>Alamat</label>
                      <input type="text" name="address" id="data_alamat" class="form-control" value="<?php echo $val['alamat'] ?>" placeholder="Alamat">
                  </div>
                  <br><br>
                  <div class="col-12">
