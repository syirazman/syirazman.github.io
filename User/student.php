                    ...
                    <?php  foreach($amanData as $aman){ 
                        ...
                        if($test['status'] == ''){
                            ...
                            <select class="form-control aman_data" name="status[]">
                                ...
                                <option value="insert/'.$userID.'/atend" style="background-color:green">Atend</option>
                                <option value="insert/'.$userID.'/absent" style="background-color:red; color:white;">Absent</option>
                            </select>';
                        } else if($test['status'] == 'atend'){
                            $status = '
                            <select class="form-control aman_data" name="status[]">
                                <option value="update/'.$userID.'/atend" selected style="background-color: green">Atend</option>
                                <option value="update/'.$userID.'/absent" style="background-color: red; color:white;">Absent</option>
                            </select>';
                        } else {
                            $status = '
                            <select class="form-control aman_data" name="status[]">
                                <option value="update/'.$userID.'/atend" style="background-color:green;" >Atend</option>
